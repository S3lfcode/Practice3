...
fun main() {
    generateStrings(4,6).operate(Operation.SORT_ASC).print()
    generateStrings(4,6).operate(Operation.SORT_DESC).print()
    generateStrings(4,6).operate(Operation.SHUFFLE).print()
    generateInt(8).operate(Operation.SORT_ASC).print()
    generateInt(8).operate(Operation.SORT_DESC).print()
    generateInt(8).operate(Operation.SHUFFLE).print()
}
